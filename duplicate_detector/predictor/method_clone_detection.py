...
def computeMethodRepresentation(astmethod):
    global StatementTrees
    try:

        clean_statement(astmethod)
        # StatementTrees.append(t)
        # appendToCorpus(t)
        pluckStatementAndAppendToStatementTree(astmethod)
...
def makeFinalOutputDecision(astmethod1, astmethod2):
    method1Repr = computeMethodRepresentation(astmethod1)
    method2Repr = computeMethodRepresentation(astmethod2)
